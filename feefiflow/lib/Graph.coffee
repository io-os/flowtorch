...
#
#graphs are Event Emitters, providing signals when the graph
# definition changes.
#
window.FeeFiFlow or= {}
...
# Originally based on Noflo's MIT licensed implementation but gutted and rebuilt since.
module.exports = window.FeeFiFlow.Graph =
class Graph extends EventEmitter
  ...
  # based on the typescript functions i think
  getComponentInfo: (componentName) ->
    component = {
      outports: [
        { name: 'test_out', type: 'string' }
      ]
      inports: [
  ...
  # a node may contain information on what component it is and
  ...
  # to components atnetwork start-up time. This could include
...
Graph.loadJSON = (definition, success, metadata = {}) ->
